...
class AnalogLearningView(QWidget):
    """Interactive Engineering Textbook Reader for Analog Electronics with Topic-Aware Visibility."""
    ...
    def __init__(self, parent=None):
        ...
        self.data_dir = os.path.join("src", "data", "analog_electronics")
    ...
    def init_ui(self):
        ...
        flow_lbl = QLabel("● Wave Shaping  ➔  ● Rectifiers  ➔  ● Filters  ➔  ● Transients & Resonance  ➔  ● Multivibrators")
        flow_lbl.setStyleSheet("color: #94A3B8; font-size: 8.5pt; font-weight: 500;")

        prog_lbl = QLabel("Overall Progress: 62%")
        ...
        tree_header = QLabel("🗺️ Analog Electronics Curriculum")
    ...
    def render_reader(self, topic, title_str):
        ...
        top_r = QHBoxLayout()
        cat_lbl = QLabel(f"CATEGORY: {topic.get('category', 'Analog Electronics').upper()}")
        ...
        if topic.get("derivation_steps"):
            ...
            d_hdr = QHBoxLayout()
            d_title = QLabel("📐 Step-by-Step Mathematical Derivation")
        ...
        if topic.get("important_formulas"):
            ...
            f_title = QLabel("⚡ Governing Formulas")
        ...
        # 6. TOPIC-AWARE ACTION BUTTONS (Problem Solving & Simulation)
