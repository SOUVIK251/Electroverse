...
from .dashboard_view import AnalogDashboardView
from .learning_view import AnalogLearningView
from .problem_solving_view import AnalogProblemSolvingView
from .simulation_view import AnalogSimulationView
from src.ui.components.cbt_exam_widget import CBTExamWidget
from .reference_view import AnalogReferenceView

class AnalogHubView(QWidget):
    """Master Analog Electronics Learning & Simulation Environment with Subject Dashboard & Topic-Aware Tab Visibility."""

    def __init__(self, main_window=None, parent=None):
        super().__init__(parent)
        self.main_window = main_window
        log.info("Initializing AnalogHubView master 6-tab environment with Subject Dashboard")
        self.init_ui()
    ...
    def init_ui(self):
        ...
        t_lbl = QLabel("ANALOG ELECTRONICS CIRCUIT HUB")
        ...
        # Tab 0: 🏠 Dashboard
        self.dash_widget = AnalogDashboardView(self)
        ...
        # Tab 1: 📖 Learn
        self.learn_widget = AnalogLearningView(self)
        ...
        # Tab 5: 📚 Reference
        self.ref_widget = AnalogReferenceView(self)
