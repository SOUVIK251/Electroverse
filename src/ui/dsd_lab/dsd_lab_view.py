...
class DSDLabView(QWidget):
    ...
    def create_top_control_bar(self):
        ...
        self.exp_combo.addItem("8. Half Adder Circuit", "half_adder")
        self.exp_combo.addItem("9. Full Adder Circuit", "full_adder")
        self.exp_combo.addItem("10. 2:1 Multiplexer (MUX)", "mux_2_1")
        self.exp_combo.addItem("11. 2:4 Decoder", "decoder_2_4")
        self.exp_combo.addItem("12. 4:2 Encoder", "encoder_4_2")
        self.exp_combo.addItem("13. D Flip-Flop", "d_flip_flop")
